...
public class TestBookingCom {
	...
	private void findHotels() {
		...
		element = driver.findElement(By.className("xp__dates-inner"));
		element.click();
		element = driver.findElement(By.xpath(".//td[@data-date=\"2019-03-01\"]"));
		element.click();
		element = driver.findElement(By.xpath(".//td[@data-date=\"2019-03-04\"]"));
		element.click();
	...
	public void checkRatingOfHotelInMoscow() {
		findHotels();
		element = driver.findElement(By.xpath(".//*[@class=\" sort_category   sort_review_score_and_price \"]"));
		element.click();
		element = driver.findElement(By.xpath("(.//a[@class=\"hotel_name_link url\"])[1]"));
		element.click();
